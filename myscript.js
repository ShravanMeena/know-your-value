...
function thirteen() {
  ...
  if (thirteenq == null) {
    ...
    let Data = {
      ...
      category: sixq,
      profileURL: seventhq,
      noOfFollowers: eightq,
      weeklyPost: nineq,
      noOfPromotions: tenq,
      existingCommunity: elevenq,
      noOfDmAndMessages: twelq,
      isSellTOUsers: thirteenq,
      totalWorthPerMonth: finalworth,
    };
    // totalWorthPerMonth
    ...
    $.ajax({
      type: "POST",
      url: "https://betafinal.fleeks.co.in/api/fleeker-earning/evaulate",
